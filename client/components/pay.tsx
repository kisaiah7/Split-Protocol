...
const Pay: NextPage = () => {
  return (
    <form className="absolute z-20 bg-secondary px-10 py-8 sm:container mx-auto rounded-lg">
      <div className="grid grid-cols-2 w-full gap-3">
        ...
        <div>
          <label className="text-muted text-xs mb-2">
            Share amount (in selected token)
          </label>
          <input
            type="number"
            className="w-full bg-form-field text-secondary text-sm px-3 py-2 rounded-sm"
        ...
        <div>
          <label className="text-muted text-xs mb-2">
            Share amount (in recipient token)
          </label>
          <input
            type="number"
            className="w-full bg-form-field text-secondary text-sm px-3 py-2 rounded-sm"
      ...
      <div className="border-b-2 pb-3 border-tertiary mt-5 grid grid-cols-2 w-full gap-x-3 text-secondary text-sm">
        ...
        <span className="col-span-2 mt-2 flex justify-end text-muted text-xs flex items-center">
          ...
          <p className="ml-1">
            ...
            order to swap ETH to USDT a small fee has to be provided.
          </p>
        </span>
      </div>
      ...
      <div className="text-primary flex justify-end mt-7">
        <button className="flex items-center bg-cancel-gradient tracking-widest px-2 py-1 text-sm rounded-sm">
